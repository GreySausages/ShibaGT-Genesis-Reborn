    ...
    internal class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            { // fun
                ...
                new ButtonInfo { buttonText = "Stun Grenade", method = () => StunGrenadeManager.StunLoop(), disableMethod = () => StunGrenadeManager.Kill(), isTogglable = true, toolTip = "Hold RG to hold grenade, release to throw (3s timer)"},
